...
- **Diagrams can be zoomed and opened full window.** Hover a drawn diagram for controls
  in its corner: zoom in and out, **Fit** to go back to the column, and an arrow that
  fills the window with it. The full-window view opens at whatever size uses the room
